...
int main() {
    ...
    Student *studentsList = createStudent("Никифоров", "Денчик", "man", 17, "исп206", 4, 5, 4);
    Student *student2 = createStudent("Семенов", "Ярослав", "man", 17, "исп206", 5, 4, 2);
    Student *student3 = createStudent("Гераськина", "Настя", "woman", 17, "исп206", 3, 3, 3);
    Student *student4 = createStudent("Давыденко", "Рома", "man", 17, "исп206", 4, 4, 4);
